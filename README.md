...
![GitHub Repo stars](https://img.shields.io/github/stars/lovethakker02/sp-dev-fx-webparts?style=social)
![GitHub forks](https://img.shields.io/github/forks/lovethakker02/sp-dev-fx-webparts?style=social)
![GitHub watchers](https://img.shields.io/github/watchers/lovethakker02/sp-dev-fx-webparts?style=social)
...
[![GitHub issues](https://img.shields.io/github/issues/lovethakker02/sp-dev-fx-webparts)](https://github.com/lovethakker02/sp-dev-fx-webparts/issues)
[![GitHub pull requests](https://img.shields.io/github/issues-pr/lovethakker02/sp-dev-fx-webparts)](https://github.com/lovethakker02/sp-dev-fx-webparts/pulls)
...
* You have issue on specific web part or sample - use [issue list in this repository](https://github.com/lovethakker02/sp-dev-fx-webparts/issues).
...
```shell
git clone https://github.com/lovethakker02/sp-dev-fx-webparts.git
```
